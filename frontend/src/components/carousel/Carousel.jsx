...
export default function Carousel() {
  ...
  return (
    <div className="flex flex-col justify-center items-center w-screen h-screen">
      <div className="w-full h-3/6 mt-36 max-sm:mt-16 max-sm:h-4/6" id="car">
        {projet
          .filter((el) => el.id === isActive)
          .map((el) => (
            <div
              className="flex gap-6 items-center justify-center w-10/12 h-full m-auto max-sm:flex-col max-sm:w-11/12"
              key={el.id}
            >
              <div className="w-[60%] h-full flex justify-center items-center max-sm:w-[100%] max-sm:h-[60%]">
                <img
              ...
              <div className="w-[40%] h-full flex flex-col justify-center max-sm:w-[100%] ">
                <h2 className="text-white text-3xl max-sm:text-2xl">
                  {el.title} : {el.name}
                </h2>
